...
1. Input field to enter the desired city

2. Real-time weather data retrieval using APIs

3. Display of temperature, humidity, and wind speed

4. Dynamic city images that change with each search
